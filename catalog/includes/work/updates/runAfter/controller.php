...
class lC_Updates_Admin_run_after extends lC_Updates_Admin {
  ...
  public static function updateDB() {
    ...
    $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration_group (configuration_group_id, configuration_group_title, configuration_group_description, sort_order, visible) VALUES(22, 'Cache', 'Cache configuration setttings.', 22, 1)");
    parent::log("Database Update: INSERT INTO `" . $pf . "configuration_group (configuration_group_id, configuration_group_title, configuration_group_description, sort_order, visible) VALUES(22, 'Cache', 'Cache configuration setttings.', 22, 1)");
    $lC_Database->simpleQuery("INSERT INTO lc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable Cache', 'CACHE_ENABLED', '1', 'Do you want to enable cache?', 22, 0, NULL, '2013-08-28 10:46:22', 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))')");
    parent::log("Database Update: INSERT INTO lc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable Cache', 'CACHE_ENABLED', '1', 'Do you want to enable cache?', 22, 0, NULL, '2013-08-28 10:46:22', 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))')");
    $lC_Database->simpleQuery("INSERT INTO lc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Cache duration', 'CACHE_DURATION', '1', 'Set time frame in seconds for which the data stored in cache', 22, 0, NULL, '0000-00-00 00:00:00', NULL, NULL)");
    parent::log("Database Update: INSERT INTO lc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Cache duration', 'CACHE_DURATION', '1', 'Set time frame in seconds for which the data stored in cache', 22, 0, NULL, '0000-00-00 00:00:00', NULL, NULL)");
