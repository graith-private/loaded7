...
/**
  ...
  @version    $Id: importCategories.php v1.0 2013-12-03 resultsonlyweb $
*/
?>
<script>
      ...
      if (typeof(data.error) != 'undefined') {
        ...
        $.modal({
          content: '<div id="importCategories">'+
                   ...
                   '    <p id="importCategoriesConfirmMessage">' + data.total + ' <?php echo $lC_Language->get('text_records_imported'); ?></p>'+
                   '    <p id="importCategoriesConfirmMessage">' + data.matched + ' <?php echo $lC_Language->get('text_matched_and_updated'); ?></p>'+
                   '    <p id="importCategoriesConfirmMessage">' + data.inserted + ' <?php echo $lC_Language->get('text_new_records_added'); ?></p>'+
                   '  </div>'+
                   '</div>',
